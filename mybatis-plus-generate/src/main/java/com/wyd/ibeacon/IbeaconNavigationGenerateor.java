...
public class IbeaconNavigationGenerateor {
    ...
    // TODO 修改服务名以及数据表名
    private static final String SERVICE_NAME = "ibeacon_navigation";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(System.getProperty("user.dir") + "com/wyd/ibeacon_navigation");
        gc.setAuthor("wyd");
        gc.setOpen(false);
